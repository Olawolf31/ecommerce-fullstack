  ...
  return (
    <div className="h-full flex flex-row">
      <div className="bg-white h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out">
        <div className="space-y-6 md:space-y-10 mt-32">
          <div id="profile" className="space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 text-center">{user.isAdmin? "Administrator" : ""}</p>
            </div>
          </div>
          ...
          <div id="menu" className="flex flex-col space-y-2 items-start">
            <button
              ...
              className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out justify-start"
            >
              <svg
